...
Unsupported routes fail explicitly with `SessionRunnerModel.UnsupportedEndpointError`. Signed authentication remains a future provider slice.
...
export const OpenAICompatiblePlugin: PluginV2.Definition<ProviderV2.Service | AISDK.Service>

export const GatewayPlugin: PluginV2.Definition<ProviderV2.Service>

export const DynamicProviderPlugin: PluginV2.Definition<ProviderV2.Service>
```
