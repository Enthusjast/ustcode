...
import type { EffectDrizzleSqlite } from "@enthusjast/ustcode-effect-drizzle-sqlite"
...
export class Service extends Context.Service<Service, Interface>()("@ustcode/ProjectDirectories") {}
