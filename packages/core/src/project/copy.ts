...
import { Event } from "@enthusjast/ustcode-schema/project-directories"
import { ProjectCopy } from "@enthusjast/ustcode-schema/project-copy"
...
export class Service extends Context.Service<Service, Interface>()("@ustcode/ProjectCopy") {}
