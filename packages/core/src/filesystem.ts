...
import { Entry, FileSystem, FindInput, Match } from "@enthusjast/ustcode-schema/filesystem"
export { Entry, Match, Submatch } from "@enthusjast/ustcode-schema/filesystem"
...
export class Service extends Context.Service<Service, Interface>()("@ustcode/v2/FileSystem") {}
