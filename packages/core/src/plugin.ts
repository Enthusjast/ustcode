...
import type { Plugin as PluginRuntime } from "@enthusjast/ustcode-plugin/v2/effect"
...
export class Service extends Context.Service<Service, Interface>()("@ustcode/v2/Plugin") {}
