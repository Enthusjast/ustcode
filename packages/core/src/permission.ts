...
export { Effect, Rule, Ruleset } from "@enthusjast/ustcode-schema/permission"
...
export class Service extends Context.Service<Service, Interface>()("@ustcode/v2/Permission") {}
