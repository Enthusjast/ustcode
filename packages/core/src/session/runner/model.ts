...
import { type Model } from "@enthusjast/ustcode-llm"
import * as OpenAICompatibleChat from "@enthusjast/ustcode-llm/protocols/openai-compatible-chat"
import { Auth, type AnyRoute } from "@enthusjast/ustcode-llm/route"
...
export class Service extends Context.Service<Service, Interface>()("@ustcode/v2/SessionRunnerModel") {}
