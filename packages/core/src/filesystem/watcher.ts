...
import { FileSystemWatcher } from "@enthusjast/ustcode-schema/filesystem-watcher"
...
export class Service extends Context.Service<Service, Interface>()("@ustcode/v2/FileWatcher") {}

const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.USTCODE_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (location.vcs && (yield* Flag.USTCODE_EXPERIMENTAL_FILEWATCHER)) {
