...
import { ListAnchor } from "@enthusjast/ustcode-schema/session"
...
import { SessionDurable } from "@enthusjast/ustcode-schema/durable-event-manifest"
...
export class Service extends Context.Service<Service, Interface>()("@ustcode/v2/Session") {}
