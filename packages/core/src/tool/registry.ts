...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@enthusjast/ustcode-llm"
...
export class Service extends Context.Service<Service, Interface>()("@ustcode/v2/ToolRegistry") {}
