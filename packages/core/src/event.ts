...
import type { Data, Definition, Payload } from "@enthusjast/ustcode-schema/event"
...
import { Durable } from "@enthusjast/ustcode-schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@enthusjast/ustcode-schema/event").ID
export type { Data, Definition, Payload } from "@enthusjast/ustcode-schema/event"
...
export class Service extends Context.Service<Service, Interface>()("@ustcode/Event") {}
