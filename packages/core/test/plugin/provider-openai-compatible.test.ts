...
// aggregator before openai-compatible.ts is imported. Importing the plugin
// module first would enter the plugin circular import
// (openai-compatible -> internal -> provider -> openai-compatible) through the
// leaf module and hit a TDZ ReferenceError on OpenAICompatiblePlugin.
...
import { OpenAICompatiblePlugin } from "@enthusjast/ustcode-core/plugin/provider/openai-compatible"
