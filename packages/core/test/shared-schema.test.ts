...
import { SessionV2 } from "@enthusjast/ustcode-core/session"
import { Agent } from "@enthusjast/ustcode-schema/agent"
import { Location } from "@enthusjast/ustcode-schema/location"
import { Model } from "@enthusjast/ustcode-schema/model"
import { AgentAttachment, FileAttachment, Prompt, Source } from "@enthusjast/ustcode-schema/prompt"
import { Provider } from "@enthusjast/ustcode-schema/provider"
import { Project } from "@enthusjast/ustcode-schema/project"
import { ProjectDirectories } from "@enthusjast/ustcode-schema/project-directories"
import { PermissionV1 } from "@enthusjast/ustcode-schema/permission-v1"
import { Session } from "@enthusjast/ustcode-schema/session"
import { SessionInput } from "@enthusjast/ustcode-schema/session-input"
import { SessionMessage } from "@enthusjast/ustcode-schema/session-message"
import { Workspace } from "@enthusjast/ustcode-schema/workspace"
import { Command } from "@enthusjast/ustcode-schema/command"
import { Connection } from "@enthusjast/ustcode-schema/connection"
import { Credential } from "@enthusjast/ustcode-schema/credential"
import { FileSystem } from "@enthusjast/ustcode-schema/filesystem"
import { Integration } from "@enthusjast/ustcode-schema/integration"
import { LLM } from "@enthusjast/ustcode-schema/llm"
import { Permission } from "@enthusjast/ustcode-schema/permission"
import { Plugin } from "@enthusjast/ustcode-schema/plugin"
import { Pty } from "@enthusjast/ustcode-schema/pty"
import { Reference } from "@enthusjast/ustcode-schema/reference"
import { SessionTodo } from "@enthusjast/ustcode-schema/session-todo"
import { Skill } from "@enthusjast/ustcode-schema/skill"
import { AbsolutePath, DateTimeUtcFromMillis, optional, statics } from "@enthusjast/ustcode-schema/schema"
...
test("Core reuses the canonical shared schemas", async () => {
  const [
    ...
    import("@enthusjast/ustcode-core/command"),
    import("@enthusjast/ustcode-core/integration/connection"),
    import("@enthusjast/ustcode-core/credential"),
    import("@enthusjast/ustcode-core/filesystem"),
    import("@enthusjast/ustcode-core/integration"),
    import("@enthusjast/ustcode-core/location"),
    import("@enthusjast/ustcode-llm"),
    import("@enthusjast/ustcode-core/permission"),
    import("@enthusjast/ustcode-core/v1/permission"),
    import("@enthusjast/ustcode-core/project/copy"),
    import("@enthusjast/ustcode-core/pty"),
    import("@enthusjast/ustcode-core/project/schema"),
    import("@enthusjast/ustcode-core/reference"),
    import("@enthusjast/ustcode-core/session/input"),
    import("@enthusjast/ustcode-core/session/message"),
    import("@enthusjast/ustcode-core/session/todo"),
    import("@enthusjast/ustcode-core/session/prompt"),
    import("@enthusjast/ustcode-core/skill"),
    import("@enthusjast/ustcode-core/v2-schema"),
    import("@enthusjast/ustcode-core/schema"),
    import("@enthusjast/ustcode-core/workspace"),
  ])
