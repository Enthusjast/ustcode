...
- Effect plugins import `@enthusjast/ustcode-plugin/v2/effect`, not `@enthusjast/ustcode-core`.
- Public domain values use generated `@enthusjast/ustcode-sdk` types.
...
- Define `PluginHost` domain capabilities in `@enthusjast/ustcode-plugin/v2/effect`.
