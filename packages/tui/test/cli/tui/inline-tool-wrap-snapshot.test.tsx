...
const tools: readonly ToolFixture[] = [
  {
    icon: "✱",
    label:
      'Grep "USTCODE.*DB|database|sqlite|drizzle|dev.*db|data.*dir|xdg|APPDATA" in packages/ustcode/src (151 matches)',
  },
  {
    icon: "✱",
    label: 'Glob "**/*db*" in packages/ustcode (6 matches)',
  },
  {
    icon: "→",
    label: "Read packages/ustcode/src/storage/db.ts [offset=1, limit=130]",
  },
  {
    icon: "→",
    label: "Read packages/ustcode/src/index.ts [offset=1, limit=100]",
    error: "No LSP server available for this file type.",
  },
  {
    icon: "✱",
    label:
      'Grep "export const USTCODE_DB|USTCODE_DB|USTCODE_DEV|Global\\.Path\\.data|data =" in packages/ustcode/src (115 matches)',
  },
] as const
