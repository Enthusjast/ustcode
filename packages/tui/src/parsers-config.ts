...
import vueHtmlTagsHighlightsPath from "./parsers/vue-html-tags-highlights.scm" with { type: "file" }
import vueHighlightsPath from "./parsers/vue-highlights.scm" with { type: "file" }
...
export default {
  ...
  parsers: [
    ...
    {
      filetype: "vue",
      wasm: resolveWasm(vueWasmPath),
      queries: {
        highlights: [resolveWasm(vueHtmlTagsHighlightsPath), resolveWasm(vueHighlightsPath)],
      },
    },
    {
      filetype: "hcl",
    ...
    {
      filetype: "clojure",
      wasm: resolveWasm(clojureWasmPath),
      queries: {
        highlights: [
