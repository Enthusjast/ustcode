...
import type {
  ...
  ReasoningPart,
  SessionStatus,
} from "@enthusjast/ustcode-sdk/v2"
...
import { USTCODE_BASE_MODE, useBindings, useCommandShortcut, useUstcodeKeymap } from "../../keymap"
...
function ReasoningPart(props: { last: boolean; part: ReasoningPart; message: AssistantMessage }) {
  ...
  const content = createMemo(() => {
    // Some providers redact reasoning blocks; drop the placeholder.
