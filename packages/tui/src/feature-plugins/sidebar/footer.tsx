import type { TuiPlugin, TuiPluginApi } from "@enthusjast/ustcode-plugin/tui"
      ...
      <Show when={show()}>
        ...
        >
          ...
          <box flexGrow={1} gap={1}>
            ...
            <text fg={theme().textMuted}>UstCode includes free models so you can start immediately.</text>
            <text fg={theme().textMuted}>
              Connect an OpenAI-compatible provider or the UstCode gateway to use other models.
            </text>
