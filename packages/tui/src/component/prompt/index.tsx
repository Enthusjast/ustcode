...
import { registerUstcodeSpinner } from "../register-spinner"
...
import type { AssistantMessage, FilePart, UserMessage } from "@enthusjast/ustcode-sdk/v2"
  ...
  const promptCommands = createMemo(() =>
    [
      ...
      },
      {
        ...
        name: "workspace.set",
        category: "Session",
        enabled: Flag.USTCODE_EXPERIMENTAL_WORKSPACES,
        slashName: "warp",
        run: () => {
          workspace.open()
        },
