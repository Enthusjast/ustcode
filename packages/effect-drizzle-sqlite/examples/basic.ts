...
class Database extends Context.Service<Database, DatabaseShape>()("@ustcode/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@ustcode/example/UserStore") {
