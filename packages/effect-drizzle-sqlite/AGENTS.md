...
- Do not add ustcode-specific tables, paths, migrations, post-commit hooks, or domain storage APIs here.
...
- If touching Effect APIs, verify against the upstream `effect` repository's sql packages (`Effect-TS/effect`).
