...
Schema-first LLM core for ustcode. One typed request, response, event, and tool language; provider quirks live in adapters, not in calling code.

```ts
import { Effect } from "effect"
import { LLM, LLMClient } from "@enthusjast/ustcode-llm"
import { OpenAI } from "@enthusjast/ustcode-llm/providers"
...
```ts
import { OpenAI, CloudflareAIGateway } from "@enthusjast/ustcode-llm/providers"
