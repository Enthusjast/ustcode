...
- Secondary audience: UstCode and other durable agent runtimes
...
UstCode and other durable runtimes need to own persistence, tool settlement,
...
UstCode should migrate to `generateTurn` / `streamTurn`, preserving its durable
