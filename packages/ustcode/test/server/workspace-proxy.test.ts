...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips ustcode-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      expect(forwarded["x-ustcode-directory"]).toBeUndefined()
      expect(forwarded["x-ustcode-workspace"]).toBeUndefined()
