...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders USTCODE_CALLER", () => {
    process.env["USTCODE_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode USTCODE_CALLER", () => {
    process.env["USTCODE_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown USTCODE_CALLER", () => {
    process.env["USTCODE_CALLER"] = "unknown"
