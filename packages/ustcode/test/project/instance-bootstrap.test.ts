...
// Plugin bootstrap compiles the local plugin with bun, which is CPU-heavy; give
// these tests headroom so they don't time out when the full suite runs in parallel.
const bootstrapTimeout = 180_000
