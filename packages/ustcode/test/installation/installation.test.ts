// Pin the npm registry so `Installation.use.latest` queries the canonical
// registry.npmjs.org regardless of the developer's ~/.npmrc mirror.
...
import { InstallationChannel } from "@enthusjast/ustcode-core/installation/version"
  ...
  describe("latest", () => {
    ...
    testEffect(
      ...
      Effect.gen(function* () {
        ...
        expect(npmCalls).toContain(`https://registry.npmjs.org/@enthusjast/ustcode/${InstallationChannel}`)
      }),
    )
    ...
    testEffect(
      ...
      Effect.gen(function* () {
        ...
        expect(bunCalls).toContain(`https://registry.npmjs.org/@enthusjast/ustcode/${InstallationChannel}`)
      }),
    )
    ...
    testEffect(
      ...
      Effect.gen(function* () {
        ...
        expect(pnpmCalls).toContain(`https://registry.npmjs.org/@enthusjast/ustcode/${InstallationChannel}`)
      }),
    )
    ...
    testEffect(
      testLayer(
        ...
        (cmd, args) => {
          ...
          if (cmd === "brew" && args.includes("--formula") && args.includes("Enthusjast/tap/ustcode")) return ""
          if (cmd === "brew" && args.includes("--formula") && args.includes("ustcode")) return "ustcode"
          return ""
        },
      ),
    ...
    testEffect(
      testLayer(
        ...
        (cmd, args) => {
          if (cmd === "brew" && args.includes("Enthusjast/tap/ustcode") && args.includes("--formula")) return "ustcode"
