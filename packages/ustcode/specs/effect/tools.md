...
Practical reference for the current tool-migration state in `packages/ustcode`.
...
Tool tests should use the existing Effect helpers in `packages/ustcode/test/lib/effect.ts`:
