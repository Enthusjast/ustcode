 ...
 *   "@ustcode/ServerAuthConfig",
 *   {
 *     password: Config.string("USTCODE_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("USTCODE_SERVER_USERNAME").pipe(Config.withDefault("ustcode")),
 *   },
 * ) {}
 *
