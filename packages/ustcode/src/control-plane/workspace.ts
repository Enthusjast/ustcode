...
import { EventSequenceTable, EventTable } from "@enthusjast/ustcode-core/event/sql"
...
import { WorkspaceEvent } from "@enthusjast/ustcode-schema/workspace-event"
...
export class Service extends Context.Service<Service, Interface>()("@ustcode/Workspace") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        USTCODE_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        USTCODE_WORKSPACE_ID: config.id,
        USTCODE_EXPERIMENTAL_WORKSPACES: "true",
