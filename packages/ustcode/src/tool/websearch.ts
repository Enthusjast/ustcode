...
import { checksum } from "@enthusjast/ustcode-core/util/encode"
...
export function selectWebSearchProvider(sessionID: string, flags = { exa: false, parallel: false }): WebSearchProvider {
  const override = process.env.USTCODE_WEBSEARCH_PROVIDER
...
function parallelAuthHeaders() {
  const headers = { "User-Agent": `ustcode/${InstallationVersion}` }
