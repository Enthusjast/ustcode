...
import { type ToolContext as PluginToolContext, type ToolDefinition } from "@enthusjast/ustcode-plugin"
...
export class Service extends Context.Service<Service, Interface>()("@ustcode/ToolRegistry") {}
