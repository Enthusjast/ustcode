...
import { buildPrompt } from "@enthusjast/ustcode-core/session/compaction"
import { SessionCompactionEvent } from "@enthusjast/ustcode-schema/session-compaction-event"
...
export class Service extends Context.Service<Service, Interface>()("@ustcode/SessionCompaction") {}
