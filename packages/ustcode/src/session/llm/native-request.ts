import type { JsonSchema, LLMRequest, ProviderMetadata } from "@enthusjast/ustcode-llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@enthusjast/ustcode-llm"
...
export const request = (input: RequestInput) => {
  ...
  // @enthusjast/ustcode-llm request objects from ustcode's session/AI SDK-shaped data.
  return LLM.request({
