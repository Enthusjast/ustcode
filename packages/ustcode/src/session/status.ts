...
import { SessionStatusEvent } from "@enthusjast/ustcode-schema/session-status-event"
...
export class Service extends Context.Service<Service, Interface>()("@ustcode/SessionStatus") {}
