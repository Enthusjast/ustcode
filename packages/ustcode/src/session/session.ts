...
import { Slug } from "@enthusjast/ustcode-core/util/slug"
...
import type { ProviderMetadata, Usage } from "@enthusjast/ustcode-llm"
import { InstallationVersion } from "@enthusjast/ustcode-core/installation/version"
...
import { locationServiceMapLayer } from "@enthusjast/ustcode-core/location-services"
...
import { PartTable, SessionTable } from "@enthusjast/ustcode-core/session/sql"
...
import { NonNegativeInt, optional } from "@enthusjast/ustcode-core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".ustcode", "plans")
...
export const getUsage = (input: { model: Provider.Model; usage: Usage; metadata?: ProviderMetadata }) => {
  ...
  const cacheWriteInputTokens = safe(input.usage.cacheWriteInputTokens ?? 0)
  ...
  return {
    cost: safe(
      new Decimal(0)
        ...
        // TODO: improve catalog pricing support, for now:
...
export class Service extends Context.Service<Service, Interface>()("@ustcode/Session") {}
