...
import type { AssistantMessage as UstCodeAssistantMessage, Message } from "@enthusjast/ustcode-sdk/v2"
import { InstanceRef } from "@/effect/instance-ref"
import { InstanceBootstrap } from "@/project/bootstrap"
import { InstanceStore } from "@/project/instance-store"
import { makeGlobalNode, Node } from "@enthusjast/ustcode-core/effect/app-node"
...
export type AssistantTokenCost = Pick<UstCodeAssistantMessage, "cost" | "tokens">

export type AssistantMessage = AssistantTokenCost &
  Pick<UstCodeAssistantMessage, "role"> &
  Partial<Pick<UstCodeAssistantMessage, "providerID" | "modelID">>
...
export class MessageLoader extends Context.Service<MessageLoader, MessageLoaderInterface>()(
  "@ustcode/ACPUsageMessageLoader",
) {}

export class ContextLimitLoader extends Context.Service<ContextLimitLoader, ContextLimitLoaderInterface>()(
  "@ustcode/ACPUsageContextLimitLoader",
) {}

export class Service extends Context.Service<Service, Interface>()("@ustcode/ACPUsage") {}
