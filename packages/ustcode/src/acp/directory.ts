...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@ustcode/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@ustcode/ACPDirectory") {}
