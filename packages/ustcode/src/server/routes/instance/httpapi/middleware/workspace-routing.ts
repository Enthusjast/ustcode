...
>()("@ustcode/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@ustcode/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.USTCODE_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.USTCODE_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-ustcode-directory"] || process.cwd()
}
