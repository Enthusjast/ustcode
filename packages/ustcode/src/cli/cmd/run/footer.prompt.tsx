...
import { normalizePromptContent } from "@enthusjast/ustcode-tui/editor"
...
import { USTCODE_BASE_MODE, useBindings } from "@enthusjast/ustcode-tui/keymap"
...
export function createPromptState(input: PromptInput): PromptState {
  ...
  const slashOptions = createMemo<SlashOption[]>(() => {
    const builtins = [
      ...
      { kind: "slash", name: "exit", display: "/exit", description: "close UstCode" } satisfies SlashOption,
    ]
