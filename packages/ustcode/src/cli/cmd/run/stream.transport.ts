...
import type { Event, GlobalEvent, UstcodeClient } from "@enthusjast/ustcode-sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@ustcode/RunStreamTransport") {}
