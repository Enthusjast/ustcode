...
//
// The saved variant persists across sessions in ~/.local/state/ustcode/model.json
...
class Service extends Context.Service<Service, VariantService>()("@ustcode/RunVariant") {}
