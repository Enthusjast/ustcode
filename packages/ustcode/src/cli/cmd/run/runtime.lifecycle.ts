...
import { openEditor } from "@enthusjast/ustcode-tui/editor"
import { registerUstcodeKeymap } from "@enthusjast/ustcode-tui/keymap"
...
export async function createRuntimeLifecycle(input: LifecycleInput): Promise<Lifecycle> {
  ...
  try {
    ...
    unregisterKeymap = registerUstcodeKeymap(keymap, renderer, input.tuiConfig)
