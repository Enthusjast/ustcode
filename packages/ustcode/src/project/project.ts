...
import { ProjectDirectoryTable, ProjectTable } from "@enthusjast/ustcode-core/project/sql"
import { ProjectDirectories } from "@enthusjast/ustcode-core/project/directories"
...
import { which } from "@enthusjast/ustcode-core/util/which"
...
export class Service extends Context.Service<Service, Interface>()("@ustcode/Project") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(Project.Vcs))(Flag.USTCODE_FAKE_VCS)
