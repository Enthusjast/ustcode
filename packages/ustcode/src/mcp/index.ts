...
import { ConfigMCPV1 } from "@enthusjast/ustcode-core/v1/config/mcp"
...
import { McpEvent } from "@enthusjast/ustcode-schema/mcp-event"
import { McpBrowser } from "./browser"

const DEFAULT_TIMEOUT = 30_000
const CLIENT_OPTIONS = {
  capabilities: {
    // https://github.com/Enthusjast/ustcode/issues/11948
    // sampling: {},
    // https://github.com/Enthusjast/ustcode/issues/23066
    // elicitation: {},
    // https://github.com/Enthusjast/ustcode/issues/2308
    roots: {},
    // https://github.com/Enthusjast/ustcode/issues/28567
    // tasks: {},
  },
...
function createClient(directory: string) {
  const client = new Client({ name: "ustcode", version: InstallationVersion }, CLIENT_OPTIONS)
...
export class Service extends Context.Service<Service, Interface>()("@ustcode/MCP") {}
            ...
            if (isAuthError) {
              if (lastError.message.includes("registration") || lastError.message.includes("client_id")) {
                ...
                return events
                  .publish(TuiEvent.ToastShow, {
                    title: "MCP Authentication Required",
                    message: `Server "${key}" requires authentication. Run: ustcode mcp auth ${key}`,
                    variant: "warning",
                    duration: 8000,
                  })
                  .pipe(Effect.ignore, Effect.as(undefined))
