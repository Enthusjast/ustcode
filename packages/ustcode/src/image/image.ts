...
export class Service extends Context.Service<Service, Interface>()("@ustcode/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __USTCODE_PHOTON_WASM_PATH?: string }).__USTCODE_PHOTON_WASM_PATH =
