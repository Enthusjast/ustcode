...
import { path } from "@enthusjast/ustcode-core/effect/app-node-platform"
...
import type { ProjectV2 } from "@enthusjast/ustcode-core/project"
...
import { WorktreeEvent } from "@enthusjast/ustcode-schema/worktree-event"
...
export class Service extends Context.Service<Service, Interface>()("@ustcode/Worktree") {}
  ...
  Effect.gen(function* () {
    ...
    const candidate = Effect.fn("Worktree.candidate")(function* (input: {
      ...
      for (const attempt of Array.from({ length: MAX_NAME_ATTEMPTS }, (_, i) => i)) {
        ...
        const branch = input.detached ? undefined : `ustcode/${name}`
